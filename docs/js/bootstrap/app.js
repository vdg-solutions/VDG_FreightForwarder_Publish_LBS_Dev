  ...
  _renderNav() {
    return html`
      ...
      <div class="mt-auto px-4 py-3 border-t border-slate-800 text-[10px] text-slate-500 flex items-center justify-between">
        ...
        <span class="font-mono whitespace-nowrap" title="build c4bc3e1f">v0.4.70 (c4bc3e1f)</span>
      </div>
    `;
  }
  render() {
...
function loadOnce() {
  ...
  if (!inflight) {
    inflight = (async () => {
      const mod = await import(new URL("pkg/vdg_freight.js?v=c4bc3e1f", document.baseURI).href);
      const wasmUrl = new URL("pkg/vdg_freight_bg.wasm?v=c4bc3e1f", document.baseURI).href;
...
var APP_VERSION = "v0.4.70 (c4bc3e1f)";
